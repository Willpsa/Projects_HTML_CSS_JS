...
class Bd {
    ...
    gravar(d) {
        let id = this.getProximaId()
        //JSON.stringify converte objeto para stgring
    ...
    recuperarTodosRegistros() {
        ...
        //JSON.parse  converte uma string para um objeto
        for (let i = 1; i <= id; i++) {
...
function carregaListaDespesas(despesas = Array(), filtro = false) {
    ...
    despesas.forEach(function (d) {
        ...
        linha.insertCell(3).innerHTML = `R$ ${d.dia}`
